...
//  }
   ...
   * Special Messages
   */
  groupMaster2 ! Broadcast("hello, everyone, get in here!")

  // they're are handled separately
  // PoisonPill and Kill are NOT routed - they have have their own routing actor
